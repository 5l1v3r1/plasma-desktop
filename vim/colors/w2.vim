...
hi IncSearch  ctermfg=White ctermbg=LightGreen  cterm=NONE
hi VertSplit  ctermfg=White ctermbg=242 cterm=NONE
hi Underlined ctermfg=111 ctermbg=NONE  cterm=underline 
hi Ignore   ctermfg=16  ctermbg=NONE


hi Number          term=bold ctermfg=Yellow ctermbg=NONE  cterm=NONE

" Functions
hi shFunction      ctermfg=28
hi Function        ctermfg=322
...
" text inside functiuon  - - - - - - - - - - - - - - - - - - - - - - - - - - -

 hi Constant  term=NONE ctermbg=NONE ctermfg=LightGray
...
hi Conditional     term=bold,reverse ctermfg=Magenta guifg=Brown
